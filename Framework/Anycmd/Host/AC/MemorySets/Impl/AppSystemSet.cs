...
namespace Anycmd.Host.AC.MemorySets.Impl
{
    ...
    {
        public static readonly IAppSystemSet Empty = new AppSystemSet(AppHost.Empty);
        ...
        #region Ctor
        public AppSystemSet(IAppHost host)
        {
            if (host == null)
            {
                ...
                lock (this)
                {
                    if (!_initialized)
                    {
                        ...
                        foreach (var appSystem in appSystems)
                        {
                            ...
                            var value = AppSystemState.Create(host, appSystem);
