        ...
        public string FilterString(List<FilterData> filters, string alias, out List<ObjectParameter> prams)
        {
            ...
            foreach (var filter in stringList)
            {
                ...
                if (comparision == "like")
                {
                    ...
                    prams.Add(new ObjectParameter(filter.field + i.ToString(), value));
                }
                else
                {
                    result.Append(comparision).Append("@").Append(filter.field).Append(i);
                    prams.Add(new ObjectParameter(filter.field + i.ToString(), filter.value));
                }
                result.Append(" and ");
                i++;
            }
            ...
            foreach (var g in numericList)
            {
                ...
                foreach (var filter in g)
                {
                    ...
                    prams.Add(new ObjectParameter(filter.field + i.ToString() + j.ToString(), filter.value));
                    j++;
                }
            ...
            foreach (var filter in listList)
            {
                ...
                prams.Add(new ObjectParameter(filter.field + i.ToString(), filter.value.ToString().Replace("[", "( ").Replace("]", " )").Replace("\"", "'")));
                i++;
            }
            #endregion
