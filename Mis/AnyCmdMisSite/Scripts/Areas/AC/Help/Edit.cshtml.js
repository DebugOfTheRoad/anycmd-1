    ...
    $().ready(function () {
        KindEditor.ready(function (K) {
            ...
            $(".btnOk").click(function () {
                ...
                var p = getParams();
                var url = bootPATH + "../AC/Help/SaveTooltip?pageID=" + p.id + "&appSystemCode=" + p.appSystemCode + "&areaCode=" + p.areaCode + "&resourceCode=" + p.resourceCode + "&functionCode=" + p.functionCode;
                $.ajax({
                    url: url,
                    type: "post",
                    data: o,
