...
(function (window, $) {
    mini.namespace("AC.RDatabase.ViewColumns");
    var self = AC.RDatabase.ViewColumns;
    self.prifix = "AC_RDatabase_ViewColumns_";
    self.loadData = loadData;
    self.search = search;
    self.gridReload = function () {
        grid.reload();
    };
    mini.namespace("AC.RDatabase.ViewColumns.ViewColumnEdit");
    var edit = AC.RDatabase.ViewColumns.ViewColumnEdit;
    edit.SetData = SetData;
    edit.prifix = "AC_RDatabase_ViewColumns_ViewColumnEdit_"
    ...
    var helperDrawcell = helper.ondrawcell(self, "AC.RDatabase.ViewColumns");
    ...
    function getParams() {
        ...
        if (self.params && self.params.databaseID) {
            ...
            data.viewName = self.params.viewName;
            ...
            data.viewName = fragment.viewName || querystring.viewName;
            data.viewID = fragment.viewID || querystring.viewID;
        }
        return data;
    }
    ...
    function SetData(data) {
        ...
        if (data.action == "edit") {
            $.ajax({
                url: bootPATH + "../AC/RDatabase/GetViewColumn",
    ...
    helper.edit.allInOne(
        self,
        win,
        bootPATH + "../AC/RDatabase/UpdateViewColumn",
        bootPATH + "../AC/RDatabase/UpdateViewColumn",
        bootPATH + "../AC/RDatabase/GetViewColumn",
        form, edit);
})(window, jQuery);