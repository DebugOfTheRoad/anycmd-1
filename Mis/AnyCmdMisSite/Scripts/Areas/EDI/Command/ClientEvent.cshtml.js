...
(function (window) {
    mini.namespace("Command.ClientEvent");
    var self = Command.ClientEvent;
    self.prifix = "EDI_Command_ClientEvent_";
    ...
    var tabConfigs = {
        infoTab: {
            url: bootPATH + "../EDI/Command/Details?entityTypeCode=ClientEvent",
            entityTypeCode: "ClientEvent",
            controller:"Command",
            params: [
                { "pName": 'commandType', "pValue": "ClientEvent" },
                { "pName": 'id', "pValue": "Id" },
                { "pName": 'ontologyCode', "pValue": "Ontology" }],
            namespace: "ClientEvent.Details"
        }
    };
    ...
    var helperDrawcell = helper.ondrawcell(self, "Command.ClientEvent");
    ...
    helper.index.allInOne(
        ...
        bootPATH + "../EDI/Command/Edit?ontologyCode=" + ontologyCode,
        bootPATH + "../EDI/Command/DeleteClientEvent",
        self);
