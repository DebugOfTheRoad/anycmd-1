...
(function (window) {
    mini.namespace("Command.EntityDistributeFailingMessages");
    var self = Command.EntityDistributeFailingMessages;
    self.prifix = "EDI_Command_EntityDistributeFailingMessages_";
