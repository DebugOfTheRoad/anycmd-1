...
namespace Anycmd.EDI.Client
{
    ...
    {
        private readonly List<KeyValue> list = new List<KeyValue>();
        ...
        public KeyValueBuilder(string[] keys, string[] values)
        {
            ...
            {
                var infoValue = new KeyValue();
                infoValue.Key = keys[i];
        ...
        public KeyValueBuilder(IEnumerable<KeyValue> source)
        {
            if (source != null)
            {
                ...
                {
                    list.Add(new KeyValue(item.Key, item.Value));
                }
            }
        }
