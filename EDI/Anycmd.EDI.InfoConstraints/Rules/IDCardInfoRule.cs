...
namespace Anycmd.EDI.InfoConstraints
{
    ...
    {
        private static readonly string actorID = "048A8089-1771-4D9A-B0EA-4AFE00120209";
        private static readonly Guid id = new Guid(actorID);
        private static readonly string title = "身份证件号验证器";
        private static readonly string description = "检测身份证件号是否合法，否则将当前命令的状态码置为InvalidInfoValue";
