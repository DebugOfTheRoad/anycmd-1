...
namespace Anycmd.EDI.InfoConstraints
{
    ...
    {
        private static readonly string actorID = "3B7892D3-9480-4E80-8A08-4D9AEF0EA9F4";
        private static readonly Guid id = new Guid(actorID);
        private static readonly string title = "真实姓名验证器";
        private static readonly string description = "检测中国人的真实姓名是否合法，要求中间和两头不要有空格，否则将当前命令的状态码置为InvalidInfoValue";
