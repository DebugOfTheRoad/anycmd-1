...
namespace Anycmd.EDI.MessageTransfers
{
    ...
    {
        private static readonly string actorID = "E8AC7575-EA84-419C-B4A0-0A2B62ACF8E7";
        private static readonly Guid id = new Guid(actorID);
        private static readonly string title = "WebApi";
        private static readonly string description = "WebApi传输器。调用命令接收节点的WebApi服务传送命令。";
