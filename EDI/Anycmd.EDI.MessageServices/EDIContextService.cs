...
namespace Anycmd.EDI.MessageServices {
    ...
    public sealed class EDIContextService : Service {
        ...
        public GetAllStateCodesResponse Any(GetAllStateCodes request) {
            ...
            foreach (var stateCode in StateCodes.SingleInstance) {
        ...
        public GetAllOntologiesResponse Any(GetAllOntologies request) {
            var ontologies = NodeHost.Instance.Ontologies;
        ...
        public GetOntologyResponse Any(GetOntology request) {
            ...
            if (request == null || !NodeHost.Instance.Ontologies.TryGetOntology(request.OntologyCode, out ontology) || ontology.Ontology.IsEnabled != 1) {
        ...
        public GetInfoDicsResponse Any(GetAllInfoDics request) {
            var infoDics = NodeHost.Instance.InfoDics;
        ...
        public GetInfoDicResponse Any(GetInfoDic request) {
            ...
            if (request == null || !NodeHost.Instance.InfoDics.TryGetInfoDic(request.DicCode, out infoDic) || infoDic.IsEnabled != 1) {
        ...
        public GetOrganizationsResponse Any(GetAllOrganizations request) {
            ...
            if (NodeHost.Instance.AppHost.OrganizationSet != null)
            {
                foreach (var item in NodeHost.Instance.AppHost.OrganizationSet)
                {
